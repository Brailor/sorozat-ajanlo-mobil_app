   ...
   shows: any;
    constructor(
      ...
      public specresult: SpecresultService
          ...
          this.shows = this.params.data;
        }
        openModal(id){
          let modal = this.modalCtrl.create(SearchModalContentPage, {spec_show : this.specresult.showSpecificShow(id)});
          console.log(modal);
          modal.present();
        }   
    }
...
//ez a modal igazából ugyan az, mint a discover-result modalja, szóval nem lenne muszáj még egyet csinálnom, de ha esetleg azt akarom, hogy
//a searc-result modalja máshogy nézzen ki, mint a discover, akkor így jobb megcsinálni
export class SearchModalContentPage {
 Show: any;
